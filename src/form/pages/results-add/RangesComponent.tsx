            ...
            <div className="flex flex-col md:flex-row gap-2">
                <div className="flex gap-1 md:flex-col">
                    <div className="flex flex-row justify-between">
                        ...
                        <p className="text-sm text-neutral-light font-light sm-hidden-block">{control.calibration_ranges.c1.low} - {control.calibration_ranges.c1.high}</p>
                    </div>
                ...
                <div className="flex gap-1 md:flex-col">
                    <div className="flex flex-row justify-between">
                        ...
                        <p className="text-sm text-neutral-light font-light sm-hidden-block">{control.calibration_ranges.c2.low} - {control.calibration_ranges.c2.high}</p>
                    </div>
