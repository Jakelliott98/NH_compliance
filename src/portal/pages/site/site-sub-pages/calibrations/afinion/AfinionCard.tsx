...
export default function AfinionCard ({ afinion }: AfinionCardProps) {
    return (
            <div className="rounded-lg bg-gray-100 p-4 flex flex-col gap-4 items-center">
                ...
                <p className='text-neutral-light'>NH{afinion.nh_number}</p>
                <div className='flex gap-2'>
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        <p className='text-sm text-neutral-light text-center'>{afinion.last_calibrated ? moment(afinion.last_calibrated).format("Do MMMM") : 'No calibrations'}</p>
                    </div>
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        <p className='text-sm text-neutral-light text-center'>{afinion.last_clean ? moment(afinion.last_clean).format("Do MMMM") : 'No cleans'}</p>
                    </div>
                </div>
            </div>
    )
