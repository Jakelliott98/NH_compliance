    ...
    return (
        <div className="py-4">
            <div className="flex-1 border-b border-gray-200 pb-2">
                ...
                <p className="sm-hidden-block text-sm text-neutral-light">Generate and export compliance reports for individual sites or across the organisation, including missed checks and overall compliance status.</p>
            </div>
            <div className="py-2 border-b border-gray-200">
                <div>
                    <h2 className="text-sm">Find site</h2>
                    <p className="sm-hidden-inline text-sm text-neutral-light">Find the site you want to edit</p>
                </div>
                <div className="pt-2">
