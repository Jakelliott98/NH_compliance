            ...
            <DialogContent>
                <DialogHeader>
                        <div className="flex flex-col items-center gap-5">
                            <FontAwesomeIcon icon={faTrashCan} className="text-3xl bg-red-100 p-5 rounded-full text-warning"/>
                            <h1 className="font-bold text-lg">Delete</h1>  
                        </div>
                        <div className="flex flex-col items-center gap-1">
                            <p>Are you sure you want to delete {site.site_name} ?</p>
                            <p className="italic text-sm text-warning">This will delete all sites results.</p>
                        </div>
                </DialogHeader>
                <div className="flex gap-5">
                    ...
                    <DialogClose className="flex-1">
                        <button className="w-full py-1 px-3 rounded-lg bg-error hover:bg-error/90 active:bg-hover/80 text-white cursor-pointer" onClick={() => {onSubmit()}}>Confirm</button>
                    </DialogClose>
                </div>
            </DialogContent>
        </Dialog>
