    ...
    return (
        <div className="py-4">
            <div className="flex-1 border-b border-gray-200 pb-2">
                ...
                <p className="sm-hidden-block text-sm text-neutral-light">Define the timeframes used to determine compliance, including calibration validity, cleaning frequency, and fluid expiry periods. These rules control how site status is calculated.</p>
            </div>
            <div className="pt-2">
                <div>
                    <h2 className="font-semibold text-sm">Compliance Ranges</h2>
                    <p className="text-sm text-neutral-light">Control the compliance ranges for the cleaning and calibrations</p>
                </div>
                <div className="flex-3 flex flex-col md:flex-row gap-5 md:gap-1 justify-around pt-4">
                    <div className="flex flex-col justify-center gap-4">
                        ...
                        />
                        <p className="text-sm text-neutral-light italic">Adjust the period for cleaning calibrations.</p>
                    </div>
                    <div className="flex flex-col justify-center gap-4">
                        ...
                        />
                        <p className="text-sm text-neutral-light italic">Adjust the period for how often the afinions should be calibrated</p>
                    </div>
                </div>
            </div>
        </div>
