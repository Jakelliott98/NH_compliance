		...
		<div className="p-2">
			<div className="flex justify-between items-center pb-2 border-b border-gray-200">
				<header className="text-center md:text-left">
					<h1 className="text-lg md:text-2xl font-bold text-neutral">Dashboard Overview</h1>
					<p className="md:text-sm text-neutral-light">Welcome back, here is your overview of all the sites.</p>
				</header>
			</div>
	...
	return (
		<div>
			<div className="mb-2 text-center md:text-left">
				<h1 className="text-md md:text-xl font-bold text-neutral">Expired</h1>
				<p className="text-xs md:text-sm text-neutral-light">All the flagging checks from the sites</p>
			</div>
